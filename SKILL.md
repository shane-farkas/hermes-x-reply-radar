...
- **No em dashes. Ever.** This applies to every reply, including drafts generated by the on-demand "Generate Reply" button. Use a comma, a period, or restructure the sentence. Reason: em dashes are an AI-writing tell and break the "sounds like a real builder" voice.
